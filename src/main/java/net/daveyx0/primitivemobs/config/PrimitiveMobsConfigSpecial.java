...
public class PrimitiveMobsConfigSpecial {
	...
	public static boolean festiveCreeperDestructive;
    public static int festiveCreeperCooldownMax;
    ...
    public static int festiveCreeperExtraCooldownMax;
    public static boolean festiveCreeperRingAttack;
    public static boolean festiveCreeperRingAttackDestructive;
    public static double festiveCreeperRingAttackPower;
    public static int festiveCreeperRingAttackAmount;
    public static boolean festiveCreeperRingAttackCharged;
    public static boolean festiveCreeperRingAttackDestructiveCharged;
    public static double festiveCreeperRingAttackPowerCharged;
    public static int festiveCreeperRingAttackAmountCharged;
    public static boolean festiveCreeperCrossAttack;
    public static boolean festiveCreeperCrossAttackDestructive;
    public static double festiveCreeperCrossAttackPower;
    public static int festiveCreeperCrossAttackAmount;
    public static double festiveCreeperCrossAttackExtent;
    public static boolean festiveCreeperCrossAttackCharged;
    public static boolean festiveCreeperCrossAttackDestructiveCharged;
    public static double festiveCreeperCrossAttackPowerCharged;
    public static int festiveCreeperCrossAttackAmountCharged;
    public static double festiveCreeperCrossAttackExtentCharged;
    public static boolean festiveCreeperLineAttack;
    public static boolean festiveCreeperLineAttackDestructive;
    public static double festiveCreeperLineAttackPower;
    public static int festiveCreeperLineAttackAmount;
    public static double festiveCreeperLineAttackExtent;
    public static boolean festiveCreeperLineAttackCharged;
    public static boolean festiveCreeperLineAttackDestructiveCharged;
    ...
    public static int flameSpewerPreAttackCountdownMax;
    public static int flameSpewerShotLifetime;
    public static int flameSpewerShotParticles;
    public static int flameSpewerGoInvulnerableWhen;
    public static int flameSpewerGoVulnerableWhen;
    public static int flameSpewerAttackRapidfireShots;
    public static int flameSpewerAttackRapidfireInterval;
    public static double flameSpewerAttackRapidfireSpread;
    ...
    public static int rocketCreeperSpecialCooldownOver;
    ...
    public static int supportCreeperSpecialCooldownOver;
    public static int supportCreeperSpecialCooldownStunned;
    public static int supportCreeperSpecialStunnedDuration;
    ...
    public static int supportCreeperSpecialChunkRadius;
    public static String[] supportCreeperBuffListSpecial;
    public static int[] supportCreeperBuffLengthListSpecial;
    public static int[] supportCreeperBuffStrengthListSpecial;
    public static int[] supportCreeperBuffStrengthListPoweredSpecial;
...
//Format is category, key, default value, comment
		...
		festiveCreeperDestructive = config.get(category1, "Festive Creeper tnt harms terrain", true, "Enable/Disable if the Festive Creeper throws tnt that harms the terrain (this way you do not have to disable ALL Creeper explosions with mobGriefing)").getBoolean();
        festiveCreeperCooldownMax = config.get(category1, "Festive Creeper default attack cooldown", 60, "Festive Creeper default attack has this many ticks of cooldown").getInt();
        ...
        festiveCreeperExtraCooldownMax = config.get(category1, "Festive Creeper extra attacks cooldown", 200, "Festive Creeper extra attacks (if any are enabled) have this many ticks of cooldown").getInt();
        festiveCreeperRingAttack = config.get(category1, "Festive Creeper ring attack enabled (base)", true, "Whether base Festive Creepers extra attack should be able to have a ring pattern").getBoolean();
        festiveCreeperRingAttackDestructive = config.get(category1, "Festive Creeper ring attack destructive (base)", false, "Whether base Festive Creepers ring attack should be destructive").getBoolean();
        festiveCreeperRingAttackPower = config.get(category1, "Festive Creeper ring attack power (base)", 1.5, "Base Festive Creepers ring attack explosion power").getDouble();
        festiveCreeperRingAttackAmount = config.get(category1, "Festive Creeper ring attack amount (base)", 8, "Base Festive Creeper ring attack throws this many TNTs at once").getInt();
        festiveCreeperRingAttackCharged = config.get(category1, "Festive Creeper ring attack enabled (charged)", true, "Whether charged Festive Creepers extra attack should be able to have a ring pattern").getBoolean();
        festiveCreeperRingAttackDestructiveCharged = config.get(category1, "Festive Creeper ring attack destructive (charged)", false, "Whether charged Festive Creepers ring attack should be destructive").getBoolean();
        festiveCreeperRingAttackPowerCharged = config.get(category1, "Festive Creeper ring attack power (charged)", 3, "Charged Festive Creepers ring attack explosion power").getDouble();
        festiveCreeperRingAttackAmountCharged = config.get(category1, "Festive Creeper ring attack amount (charged)", 8, "Charged Festive Creeper ring attack throws this many TNTs at once").getInt();
        festiveCreeperCrossAttack = config.get(category1, "Festive Creeper cross attack enabled (base)", true, "Whether base Festive Creepers extra attack should be able to have a cross pattern").getBoolean();
        festiveCreeperCrossAttackDestructive = config.get(category1, "Festive Creeper cross attack destructive (base)", false, "Whether base Festive Creepers cross attack should be destructive").getBoolean();
        festiveCreeperCrossAttackPower = config.get(category1, "Festive Creeper cross attack power (base)", 1.5, "Base Festive Creepers cross attack explosion power").getDouble();
        festiveCreeperCrossAttackAmount = config.get(category1, "Festive Creeper cross attack amount (base)", 3, "Base Festive Creeper cross attack throws this many TNTs at once").getInt();
        festiveCreeperCrossAttackExtent = config.get(category1, "Festive Creeper cross attack extent (base)", 1.2, "Base Festive Creeper cross attack should extend this many times farther than the target's distance").getDouble();
        festiveCreeperCrossAttackCharged = config.get(category1, "Festive Creeper cross attack enabled (charged)", true, "Whether charged Festive Creepers extra attack should be able to have a cross pattern").getBoolean();
        festiveCreeperCrossAttackDestructiveCharged = config.get(category1, "Festive Creeper cross attack destructive (charged)", false, "Whether charged Festive Creepers cross attack should be destructive").getBoolean();
        festiveCreeperCrossAttackPowerCharged = config.get(category1, "Festive Creeper cross attack power (charged)", 3, "Charged Festive Creepers cross attack explosion power").getDouble();
        festiveCreeperCrossAttackAmountCharged = config.get(category1, "Festive Creeper cross attack amount (charged)", 4, "Charged Festive Creeper cross attack throws this many TNTs at once").getInt();
        festiveCreeperCrossAttackExtentCharged = config.get(category1, "Festive Creeper cross attack extent (charged)", 1.6, "Charged Festive Creeper cross attack should extend this many times farther than the target's distance").getDouble();
        festiveCreeperLineAttack = config.get(category1, "Festive Creeper line attack enabled (base)", true, "Whether base Festive Creepers extra attack should be able to have a line pattern").getBoolean();
        festiveCreeperLineAttackDestructive = config.get(category1, "Festive Creeper line attack destructive (base)", false, "Whether base Festive Creepers line attack should be destructive").getBoolean();
        festiveCreeperLineAttackPower = config.get(category1, "Festive Creeper line attack power (base)", 1.5, "Base Festive Creepers line attack explosion power").getDouble();
        festiveCreeperLineAttackAmount = config.get(category1, "Festive Creeper line attack amount (base)", 8, "Base Festive Creeper line attack throws this many TNTs at once").getInt();
        festiveCreeperLineAttackExtent = config.get(category1, "Festive Creeper line attack extent (base)", 2.0, "Base Festive Creeper line attack should extend this many times farther than the target's distance").getDouble();
        festiveCreeperLineAttackCharged = config.get(category1, "Festive Creeper line attack enabled (charged)", true, "Whether charged Festive Creepers extra attack should be able to have a line pattern").getBoolean();
        festiveCreeperLineAttackDestructiveCharged = config.get(category1, "Festive Creeper line attack destructive (charged)", false, "Whether charged Festive Creepers line attack should be destructive").getBoolean();
        ...
        flameSpewerPreAttackCountdownMax = config.get(category1, "Flame Spewer attack countdown duration total", 100, "Flame Spewer has total countdown this long between attacks").getInt();
        flameSpewerShotLifetime = config.get(category1, "Flame Spewer small fireball lifetime", 100, "Flame Spewer small fireballs last this many ticks").getInt();
        flameSpewerShotParticles = config.get(category1, "Flame Spewer small fireball particle density", 10, "Flame Spewer small fireballs make this many particles").getInt();
        flameSpewerGoInvulnerableWhen = config.get(category1, "Flame Spewer countdown invulnerability trigger", 100, "Flame Spewer goes invulnerable when countdown between attacks is at this many ticks").getInt();
        flameSpewerGoVulnerableWhen = config.get(category1, "Flame Spewer countdown vulnerability trigger", 50, "Flame Spewer goes vulnerable when countdown between attacks is at this many ticks").getInt();
        flameSpewerAttackRapidfireShots = config.get(category1, "Flame Spewer rapidfire shot max", 10, "Flame Spewer rapidfire fireballs shoots this many").getInt();
        flameSpewerAttackRapidfireInterval = config.get(category1, "Flame Spewer rapidfire fireball interval", 3, "Flame Spewer rapidfire fireball interval in ticks").getInt();
        flameSpewerAttackRapidfireSpread = config.get(category1, "Flame Spewer rapidfire fireball spread", 0.02, "Flame Spewer rapidfire fireball spread factor").getDouble();
        ...
        rocketCreeperSpecialCooldownOver = config.get(category1, "Rocket Creeper homing cooldown when over", 400, "Rocket Creeper homing attack has this long of a cooldown in ticks when it's over").getInt();
        ...
        supportCreeperSpecialCooldownOver = config.get(category1, "Support Creeper special cooldown when over", 400, "Festive Creeper special attack has this long of a cooldown in ticks when it's over").getInt();
        ...
        supportCreeperSpecialStunnedDuration = config.get(category1, "Support Creeper special stun duration", 100, "Support Creeper stun lasts this long in ticks").getInt();
        ...
        supportCreeperSpecialChunkRadius = config.get(category1, "Support Creeper special buff chunk radius", 2, "Support Creeper special attacks buffs mobs in this chunk radius").getInt();
        supportCreeperBuffListSpecial = config.get(category1, "Support Creeper special attack buff list", new String[]{"minecraft:fire_resistance", "minecraft:speed", "minecraft:strength"}, "Support Creeper special attack applies these buffs").getStringList();
        supportCreeperBuffLengthListSpecial = config.get(category1, "Support Creeper special attack buff length list", new int[]{1200, 1200, 1200}, "Support Creeper special attack buffs have these lengths in ticks").getIntList();
        supportCreeperBuffStrengthListSpecial = config.get(category1, "Support Creeper special attack buff strength list (base)", new int[]{1, 1, 1}, "Support Creeper special attack buffs have these amplifiers when not charged").getIntList();
        supportCreeperBuffStrengthListPoweredSpecial = config.get(category1, "Support Creeper special attack buff strength list (charged)", new int[]{2, 2, 2}, "Support Creeper special attack buffs have these amplifiers when charged").getIntList();
	...
	public static boolean getFestiveCreeperDestructive() 
    {
        return festiveCreeperDestructive;
    }

    public static int getFestiveCreeperCooldownMax() 
    {
        return festiveCreeperCooldownMax;
    }
    ...
    public static int getFestiveCreeperExtraCooldownMax() 
    {
        return festiveCreeperExtraCooldownMax;
    }

    public static boolean getFestiveCreeperRingAttack() 
    {
        return festiveCreeperRingAttack;
    }

    public static boolean getFestiveCreeperRingAttackDestructive() 
    {
        return festiveCreeperRingAttackDestructive;
    }

    public static double getFestiveCreeperRingAttackPower() 
    {
        return festiveCreeperRingAttackPower;
    }
    ...
    public static boolean getFestiveCreeperRingAttackDestructiveCharged() 
    {
        return festiveCreeperRingAttackDestructiveCharged;
    }

    public static double getFestiveCreeperRingAttackPowerCharged() 
    {
        return festiveCreeperRingAttackPowerCharged;
    }

    public static int getFestiveCreeperRingAttackAmountCharged() 
    {
        return festiveCreeperRingAttackAmountCharged;
    }

    public static boolean getFestiveCreeperCrossAttack() 
    {
        return festiveCreeperCrossAttack;
    }

    public static boolean getFestiveCreeperCrossAttackDestructive() 
    {
        return festiveCreeperCrossAttackDestructive;
    }

    public static double getFestiveCreeperCrossAttackPower() 
    {
        return festiveCreeperCrossAttackPower;
    }

    public static int getFestiveCreeperCrossAttackAmount() 
    {
        return festiveCreeperCrossAttackAmount;
    }

    public static double getFestiveCreeperCrossAttackExtent() 
    {
        return festiveCreeperCrossAttackExtent;
    }

    public static boolean getFestiveCreeperCrossAttackCharged() 
    {
        return festiveCreeperCrossAttackCharged;
    }

    public static boolean getFestiveCreeperCrossAttackDestructiveCharged() 
    {
        return festiveCreeperCrossAttackDestructiveCharged;
    }

    public static double getFestiveCreeperCrossAttackPowerCharged() 
    {
        return festiveCreeperCrossAttackPowerCharged;
    }

    public static int getFestiveCreeperCrossAttackAmountCharged() 
    {
        return festiveCreeperCrossAttackAmountCharged;
    }

    public static double getFestiveCreeperCrossAttackExtentCharged() 
    {
        return festiveCreeperCrossAttackExtentCharged;
    }

    public static boolean getFestiveCreeperLineAttack() 
    {
        return festiveCreeperLineAttack;
    }

    public static boolean getFestiveCreeperLineAttackDestructive() 
    {
        return festiveCreeperLineAttackDestructive;
    }

    public static double getFestiveCreeperLineAttackPower() 
    {
        return festiveCreeperLineAttackPower;
    }

    public static int getFestiveCreeperLineAttackAmount() 
    {
        return festiveCreeperLineAttackAmount;
    }

    public static double getFestiveCreeperLineAttackExtent() 
    {
        return festiveCreeperLineAttackExtent;
    }

    public static boolean getFestiveCreeperLineAttackCharged() 
    {
        return festiveCreeperLineAttackCharged;
    }

    public static boolean getFestiveCreeperLineAttackDestructiveCharged() 
    {
        return festiveCreeperLineAttackDestructiveCharged;
    }

    public static double getFestiveCreeperLineAttackPowerCharged() 
    {
        return festiveCreeperLineAttackPowerCharged;
    }

    public static int getFestiveCreeperLineAttackAmountCharged() 
    {
        return festiveCreeperLineAttackAmountCharged;
    }

    public static double getFestiveCreeperLineAttackExtentCharged() 
    {
    ...
    public static int getFlameSpewerPreAttackCountdownMax()
    {
        return flameSpewerPreAttackCountdownMax;
    }

    public static int getFlameSpewerShotLifetime()
    {
        return flameSpewerShotLifetime;
    }

    public static int getFlameSpewerShotParticles()
    {
        return flameSpewerShotParticles;
    }

    public static int getFlameSpewerGoInvulnerableWhen()
    {
        return flameSpewerGoInvulnerableWhen;
    }

    public static int getFlameSpewerGoVulnerableWhen()
    {
        return flameSpewerGoVulnerableWhen;
    }

    public static int getflameSpewerAttackRapidfireShots()
    {
        return flameSpewerAttackRapidfireShots;
    }

    public static int getFlameSpewerAttackRapidfireInterval()
    {
        return flameSpewerAttackRapidfireInterval;
    }

    public static double getFlameSpewerAttackRapidfireSpread()
    {
        return flameSpewerAttackRapidfireSpread;
    }
    ...
    public static int getRocketCreeperSpecialCooldownOver()
    {
        return rocketCreeperSpecialCooldownOver;
    }
    ...
    public static int getSupportCreeperSpecialCooldownOver()
    {
        return supportCreeperSpecialCooldownOver;
    }
    ...
    public static int getSupportCreeperSpecialStunnedDuration()
    {
        return supportCreeperSpecialStunnedDuration;
    }
    ...
    public static int getSupportCreeperSpecialChunkRadius()
    {
        return supportCreeperSpecialChunkRadius;
    }

    public static String[] getSupportCreeperBuffListSpecial()
    {
        return supportCreeperBuffListSpecial;
    }

    public static int[] getSupportCreeperBuffLengthListSpecial()
    {
        return supportCreeperBuffLengthListSpecial;
    }

    public static int[] getSupportCreeperBuffStrengthListSpecial()
    {
        return supportCreeperBuffStrengthListSpecial;
    }

    public static int[] getSupportCreeperBuffStrengthListPoweredSpecial()
    {
        return supportCreeperBuffStrengthListPoweredSpecial;
    }
