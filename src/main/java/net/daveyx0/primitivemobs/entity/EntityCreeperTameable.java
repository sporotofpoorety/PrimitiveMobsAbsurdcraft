...
public class EntityCreeperTameable extends EntityMobTameable
{
    private static final DataParameter<Integer> STATE = EntityDataManager.<Integer>createKey(EntityCreeperTameable.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> POWERED = EntityDataManager.<Boolean>createKey(EntityCreeperTameable.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> IGNITED = EntityDataManager.<Boolean>createKey(EntityCreeperTameable.class, DataSerializers.BOOLEAN);
    ...
    public EntityCreeperTameable(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityCreeperTameable.class);
    }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (this.world.getGameRules().getBoolean("doMobLoot"))
        {
            ...
            else if (cause.getTrueSource() instanceof EntityCreeperTameable && cause.getTrueSource() != this && ((EntityCreeperTameable)cause.getTrueSource()).getPowered() && ((EntityCreeperTameable)cause.getTrueSource()).ableToCauseSkullDrop())
            {
                ((EntityCreeperTameable)cause.getTrueSource()).incrementDroppedSkulls();
