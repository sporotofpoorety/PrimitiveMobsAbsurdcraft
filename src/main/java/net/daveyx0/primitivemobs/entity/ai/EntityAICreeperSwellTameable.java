...
public class EntityAICreeperSwellTameable extends EntityAIBase
{
    /** The creeper that is swelling. */
    EntityCreeperTameable swellingCreeper;
    ...
    public EntityAICreeperSwellTameable(EntityCreeperTameable entitycreeperIn)
    {
